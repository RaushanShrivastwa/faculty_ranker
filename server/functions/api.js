...
// - Go up one directory (from 'functions' to 'server')
// - Then require the 'index.js' file within the 'server' directory.
// This is adjusted because api.js is now directly inside 'server/functions'.
const expressApp = require('../index'); // <<<--- THIS LINE HAS BEEN MODIFIED
